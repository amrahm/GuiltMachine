...
SubShader {	
	...
	Pass {  
		CGPROGRAM
			#define PATH_TRACKING_SAMPLES 200 // count of path tracking steps
			#pragma target 3.0
...
Fallback "Light2D/Light 90 Points"
