...
namespace Light2D
{
    ...
    public class LightSprite : CustomSprite
    {
        ...
        public void DrawLightingNow(Vector2 lightCamLocalPos)
        {
            ...
            var v1 = _modelMatrix.MultiplyPoint(vertices[0]) - (Vector3)lightCamLocalPos;
            var v2 = _modelMatrix.MultiplyPoint(vertices[2]) - (Vector3)lightCamLocalPos;
            var v3 = _modelMatrix.MultiplyPoint(vertices[3]) - (Vector3)lightCamLocalPos;
            var v4 = _modelMatrix.MultiplyPoint(vertices[1]) - (Vector3)lightCamLocalPos;
        ...
        public void DrawLightNormalsNow(Material material)
        {
            ...
            var v1 = _modelMatrix.MultiplyPoint3x4(vertices[0]);
            var v2 = _modelMatrix.MultiplyPoint3x4(vertices[2]);
            var v3 = _modelMatrix.MultiplyPoint3x4(vertices[3]);
            var v4 = _modelMatrix.MultiplyPoint3x4(vertices[1]);
